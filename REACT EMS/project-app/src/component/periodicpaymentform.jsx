...
useEffect(()=>{
  ...
  useEffect(()=>{
    ...
    // setValue("paymentDetails.amount",periodicpay.paymentDetails[0].amount)
    // setValue("paymentDetails.date",periodicpay.paymentDetails[0].date)
    // setValue("paymentDetails.method",periodicpay.paymentDetails[0].method)
    setValue("description",periodicpay.description)
    // setValue("description",periodicpay.paymentDetails)
  ...
  const navigate = useNavigate()
      ...
      const onSubmitHandler = (data) => {
       ...
       navigate('/primarymember/dashboard1/periodicpayment')
       }
     else{
