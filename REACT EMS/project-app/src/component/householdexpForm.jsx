...
const HouseholdexpForm =()=>{
  ...
  useEffect(()=>{
    ...
    console.log("householdexpId",householdexpId );
    ...
    setValue("paymentDetails.amount",householdex.paymentDetails[0].amount);
    setValue("paymentDetails.method",householdex.paymentDetails[0].method);
    setValue("paymentDetails.date",householdex.paymentDetails[0].date);
  ...
  const navigate = useNavigate()
      ...
      const onSubmitHandler = (data) => {
       ...
       navigate('/primarymember/dashboard1/householdexp')
       }
     else{
